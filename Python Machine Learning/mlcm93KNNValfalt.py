# Imputación  Descubre cómo manejar Datos ó Valores Faltantes Imputando con K-Vecinos más cercanos (KNN) y Python
# K-vecinos más cercanos (KNN)  Contexto
import numpy as np
...
# nan Introduccion datos faktantes
faltantes = escalados.copy()
faltantes[[2, 7, 12, 17, 22], 2] = np.nan
print(faltantes)

# Estimación e Imputación de datos faltantes
...
# Graficar datos imputados/estimados
fig = plt.figure(figsize=(8, 8))
